...
window.noUiSlider = {
  create: function(element, options) {
    ...
    const startValue = Array.isArray(currentOptions.start) ? currentOptions.start[0] : currentOptions.start;
    const initialPercentage = valueToPercentage(startValue);
    ...
    const slider = {
      updateOptions: function(newOptions) {
        ...
        if (newOptions.start !== undefined) {
          const startValue = Array.isArray(newOptions.start) ? newOptions.start[0] : newOptions.start;
          const newPercentage = valueToPercentage(startValue);
          updatePosition(newPercentage);
        }
